...
public class VkAuth {
    ...
    public static String getUrl(String api_id, String settings) {
        String url = "https://oauth.vk.com/authorize?client_id=" + api_id + "&displayFromResult=mobile&scope=" + settings + "&redirect_uri=" + URLEncoder.encode(redirect_url) + "&response_type=token"
